...
// returns middlewares ued by json server
...
// to listen server app to resolver request

mpServer.listen(port,()=>{
    console.log(`Media player server started at port : ${port} and waiting for requests`);
})
